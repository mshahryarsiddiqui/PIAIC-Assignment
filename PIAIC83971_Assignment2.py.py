...
def function3():
    ...
    x = a[a%(5*7)==0] #wrtie your code here
    return x
    """
    Expected Output:
...
def function5():
 ...
 z = np.zeros(20,dtype=np.int32).reshape(4,5) #wrtie your code here
...
def function8():
    ...
    x = np.full((2, 5), 6, dtype=np.uint) #write your code here
...
return np.where(arr%(3*5)==0,'YES','NO')          # Write Your Code HERE
...
def function18():
    ...
    x =np.count_nonzero(np.isin(piaic,students))# Write you code Here
    return x
...
def function19():
    ...
    b = np.ones(5*5)*5    # Write your code here
...
def function20():
    ...
    return abc() #Write your Code here
